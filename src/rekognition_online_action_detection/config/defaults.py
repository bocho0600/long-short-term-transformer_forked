...
_C.MODEL.LSTR.LONG_MEMORY_WINDOW_SECONDS = 0
_C.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE_SECONDS = 0
_C.MODEL.LSTR.LONG_MEMORY_WINDOW_INDEX = 0
_C.MODEL.LSTR.LONG_MEMORY_POSITION_PADDING = 0
_C.MODEL.LSTR.WORK_MEMORY_POSITION_PADDING = 0
