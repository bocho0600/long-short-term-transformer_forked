...
def assert_and_infer_cfg(cfg, args):
    ...
    if cfg.MODEL.MODEL_NAME in ['LSTR']:
        ...
        cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_LENGTH = cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_SECONDS * cfg.DATA.FPS
        cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE = cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE_SECONDS * cfg.DATA.FPS
        cfg.MODEL.LSTR.WORK_MEMORY_LENGTH = cfg.MODEL.LSTR.WORK_MEMORY_SECONDS * cfg.DATA.FPS
        if cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_LENGTH > 0:
            assert cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_LENGTH <= cfg.MODEL.LSTR.LONG_MEMORY_LENGTH
            assert cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_INDEX >= 0
            if cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE == 0:
                cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE = cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_LENGTH
            assert cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE > 0
        else:
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE = 0
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_INDEX = 0
        cfg.MODEL.LSTR.LONG_MEMORY_ACTIVE_LENGTH = \
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_LENGTH or cfg.MODEL.LSTR.LONG_MEMORY_LENGTH
        ...
        assert cfg.MODEL.LSTR.LONG_MEMORY_ACTIVE_LENGTH % cfg.MODEL.LSTR.LONG_MEMORY_SAMPLE_RATE == 0
        assert cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE % cfg.MODEL.LSTR.LONG_MEMORY_SAMPLE_RATE == 0
        ...
        cfg.MODEL.LSTR.LONG_MEMORY_FULL_NUM_SAMPLES = cfg.MODEL.LSTR.LONG_MEMORY_LENGTH // cfg.MODEL.LSTR.LONG_MEMORY_SAMPLE_RATE
        cfg.MODEL.LSTR.LONG_MEMORY_NUM_SAMPLES = cfg.MODEL.LSTR.LONG_MEMORY_ACTIVE_LENGTH // cfg.MODEL.LSTR.LONG_MEMORY_SAMPLE_RATE
        cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE_NUM_SAMPLES = \
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE // cfg.MODEL.LSTR.LONG_MEMORY_SAMPLE_RATE
        cfg.MODEL.LSTR.LONG_MEMORY_POSITION_PADDING = max(
            0,
            cfg.MODEL.LSTR.LONG_MEMORY_FULL_NUM_SAMPLES -
            cfg.MODEL.LSTR.LONG_MEMORY_NUM_SAMPLES -
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_INDEX *
            cfg.MODEL.LSTR.LONG_MEMORY_WINDOW_STRIDE_NUM_SAMPLES)
        cfg.MODEL.LSTR.WORK_MEMORY_POSITION_PADDING = cfg.MODEL.LSTR.LONG_MEMORY_FULL_NUM_SAMPLES
